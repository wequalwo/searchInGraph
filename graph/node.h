...
// Указатели нужны для ссылок в списках инцидентных узлов, а также позволяют удобно отслеживать множество посещенных вершин
// SharedPtr используем, потому что один узел инцидентен многим
template <class T>
